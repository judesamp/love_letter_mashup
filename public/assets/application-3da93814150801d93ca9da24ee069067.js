...
(function() {
  $(function() {
    $(document).on('click', '#fade', function() {
      $("#fade").hide();
      return $(".modal_custom").hide();
    });
    $(document).on('click', '.close', function() {
      $("#fade").hide();
      return $(".modal_custom").hide();
    });
    $(document).on('click', '.send_letter_button', function(e) {
      e.preventDefault();
      $('.send_letter_modal').fadeIn();
      return $('#fade').fadeIn();
    });
    $(document).on('click', '#fade_instructions', function() {
      $("#fade_instructions").hide();
      return $(".modal_custom_instructions").hide();
    });
    $(document).on('click', '.close_instructions', function() {
      $("#fade_instructions").hide();
      return $(".modal_custom_instructions").hide();
    });
    $(document).on('click', function() {
      return $('.gritter-item').fadeOut('slow');
    });
    $(document).on('click', '.snippet_view', function(e) {
      e.preventDefault();
      return $(".letter_view_workspace").hide("slide", {
        direction: "right"
      }, 600, function() {
        return $(".snippet_view_workspace").show("slide", {
          direction: "left"
        }, 600);
      });
    });
    $(document).on('click', '.letter_view', function(e) {
      var letter_id;
      e.preventDefault();
      ...
      return $(".snippet_view_workspace").hide("slide", {
        direction: "right"
      }, 600, function() {
        $(".letter_view_workspace").show("slide", {
          direction: "left"
        }, 600);
          ...
          update: function(event, ui) {
            ...
            return $(this).children().each(function() {
              ...
              return $.ajax({
                ...
                type: "PATCH",
                data: {
                  Activity: JSON.stringify(neworder)
                }
              });
            });
          }
    ...
    $(document).on('click', '.answer', function(e) {
      var checkbox, checked, initial_value, letter, snippet_id;
      ...
      return $(document).on('click', '.send_snippet_letter_button', function(e) {
        var letter_id;
        e.preventDefault();
        letter_id = $('.snippet_view_workspace').attr('id');
        $.ajax({
    ...
    return $(document).on('click', '.answer', function(e) {});
  });

}).call(this);
(function() {
  $(function() {
    $(document).on('click', '.send_email_button', function(e) {
      e.preventDefault();
      return $('.snail_mail_order_letter').slideUp(800, function() {
        return $('.email_letter_order').slideToggle(800, "linear", function() {});
      }).email_letter_order;
    });
    return $(document).on('click', '.snail_mail_button', function(e) {
      e.preventDefault();
      return $('.email_letter_order').slideUp(800, function() {
        return $('.snail_mail_order_letter').slideToggle(800, "linear", function() {});
      });
    });
  });
...
(function() {
  $(function() {
    return $(document).on('click', '.signup_button', function(e) {
      e.preventDefault();
